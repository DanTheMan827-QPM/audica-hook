...
namespace il2cpp_utils {
    namespace array_utils {
        static inline char* il2cpp_array_addr_with_size(Il2CppArray* array, int32_t size, uintptr_t idx) {
...
#define EXCEPTION_MESSAGE_SIZE 4096
    ...
    Il2CppClass* GetClassFromName(char const* name_space, char const* type_name);
    ...
    namespace il2cpp_type_check {
        ...
        struct il2cpp_arg_type_<T*> {  // we assume that pointers are already objects to get the type of
            ...
            static inline Il2CppType const* get(T const* arg) {
                return il2cpp_functions::class_get_type(il2cpp_functions::object_get_class(reinterpret_cast<Il2CppObject*>(arg)));
            }
        };
    ...
    bool ParameterMatch(MethodInfo const* method, TArgs*... args) {
    ...
    bool ParameterMatch(MethodInfo const* method, Il2CppType** type_arr, int count);
    ...
    TObj* New(Il2CppClass* klass, TArgs const&... args) {
        ...
        // runtime_invoke constructor with right number of args, return null if multiple matches (or take a vector of type pointers to resolve it),
        // return null if constructor errors

        void* myIter = nullptr;
        MethodInfo const* current;
        MethodInfo const* ctor = nullptr;
        // Il2CppType* argarr[] = {reinterpret_cast<Il2CppType*>(args)...};
    ...
    MethodInfo const* GetMethod(Il2CppClass* klass, std::string_view methodName, int argsCount);

    // Returns the MethodInfo for the method on class found via namespace and name with the given name and number of arguments
    MethodInfo const* GetMethod(std::string_view nameSpace, std::string_view className, std::string_view methodName, int argsCount);
    ...
    // Returns false if it fails
    // Created by zoller27osu
    bool RunMethod(void* instance, MethodInfo const* method, TArgs*... params) {
        void* out = nullptr;
    ...
    // Created by zoller27osu
    T* MakeAction(Il2CppObject* obj, function_ptr_t<R, TArgs...> callback, Il2CppType const* actionType) {
         ...
         */
        MethodInfo const* invoke =
            il2cpp_functions::class_get_method_from_name(actionClass, "Invoke", -1);  // well-formed Actions have only 1 invoke method
    ...
    T* MakeAction(Il2CppObject* obj, void* callback, Il2CppType const* actionType) {
    ...
    Il2CppClass* MakeGeneric(Il2CppClass const* klass, std::initializer_list<Il2CppClass const*> args);

    // Gets a C# name of a type
    char const* TypeGetSimpleName(Il2CppType const* type);

    // Function made by zoller27osu, modified by Sc2ad
    // Logs information about the given MethodInfo* as log(DEBUG)
    void LogMethod(MethodInfo const* method);
    ...
    void LogClass(Il2CppClass const* klass, bool logParents = true);
    ...
    // Created by zoller27osu
    [[nodiscard]] bool Match(Il2CppObject const* source, Il2CppClass const* klass) noexcept;

    // Asserts that a given source object is an object of the given class
    // Created by zoller27osu
    bool AssertMatch(Il2CppObject const* source, Il2CppClass const* klass);
    ...
    Il2CppObject* RuntimeInvoke(MethodInfo const* method, Il2CppObject* reference, Il2CppException** exc, TArgs*... args) {
        il2cpp_functions::Init();
